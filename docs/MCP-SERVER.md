...
- **Companion to:** [`DESIGN.md`](DESIGN.md), [`COLLABORATION.md`](COLLABORATION.md),
  [`SWITCHBOARD-KERNEL.md`](SWITCHBOARD-KERNEL.md), [`TECH-SPEC.md`](TECH-SPEC.md)
...
This amends [`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §1.1, which said agents modify *the canonical
...
[`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §5.1 called *proposal mode* — now a capability rather
...
[`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §3 specified compare-and-swap: a write carries
...
[`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §4.2 is therefore **superseded, not carried forward.**
...
([`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §3.1, retained).

---

## 7. The fence

Ported from [`SWITCHBOARD-KERNEL.md`](SWITCHBOARD-KERNEL.md) §2. It lives in `domain`, is pure, and
...
[`SWITCHBOARD-KERNEL.md`](SWITCHBOARD-KERNEL.md) §5, extended to a room:
...
[`SWITCHBOARD-KERNEL.md`](SWITCHBOARD-KERNEL.md) §2.1 defers heartbeats and TTLs to *"a later
...
[`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §9.2 — raw is honest and cheap, and `kind` tells a model
...
| Document | Change |
|---|---|
| [`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §3–§4 | Superseded. Revision-hash CAS → rebase; content-hash anchors → opaque tokens; `patch_note` → structural steps |
| [`AGENT-WORKSPACE.md`](AGENT-WORKSPACE.md) §9.1, §9.2 | Open questions closed: anchors are opaque and authority-resolved; `search` returns raw plus `kind` |
...
2. **Change budget calibration.** §10.3 requires a per-minute budget; the number should come from
   the [`POC.md`](POC.md) day-of-use observation, not from a guess made here.
