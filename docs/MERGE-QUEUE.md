...
| GitHub merge group | Full: the fast checks plus build and the complete Playwright suite | Proof for the synthetic commit that will land on `main` |
...
event, not by an agent or a second queue service.
