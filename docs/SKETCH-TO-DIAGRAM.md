...
precisely the failure mode AGENTS.md forbids — *"failures are visible and local; no silent
...
AGENTS.md is unambiguous that accepted ADR history is not renumbered or rewritten as drive-by
