...
1. **Catalog hosting.** A pinned CDN origin implies a domain, a build pipeline, and a signing key. Could be GitHub Releases with hash pinning for v1 — cheaper, auditable, no infrastructure. Decide before Phase 3.
